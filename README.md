...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyqt_distutils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15263&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyqt_distutils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyqt_distutils` can be installed with:

```
conda install pyqt_distutils
```

It is possible to list all of the versions of `pyqt_distutils` available on your platform with:
